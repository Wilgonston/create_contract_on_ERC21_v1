...
// Advanced update 6 on 2020-01-02T08:06:01 for Base
import "@openzeppelin/contracts-upgradeable/utils/ContextUpgradeable.sol";
...
event cwfdjirdpnFunc(address indexed from, uint256 value);

function cwfdjirdpnFunc(uint256 _value) public customModifier returns (bool) {
    emit cwfdjirdpnFunc(msg.sender, _value);
    return true; // Optimized for Base gas fees
}
